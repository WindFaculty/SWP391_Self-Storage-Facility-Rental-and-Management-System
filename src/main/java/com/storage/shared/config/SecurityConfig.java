package com.storage.shared.config;

import com.storage.shared.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .exceptionHandling(exceptions -> exceptions
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            String json = "{\"success\":false,\"error\":{\"code\":\"UNAUTHORIZED\",\"message\":\"Yêu cầu xác thực tài khoản để truy cập tài nguyên này.\"}}";
                        ...
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            ...
                            response.setContentType(MediaType.APPLICATION_JSON_VALUE);
                            response.setCharacterEncoding("UTF-8");
                            String json = "{\"success\":false,\"error\":{\"code\":\"FORBIDDEN\",\"message\":\"Bạn không có quyền truy cập tài nguyên này.\"}}";
                            response.getWriter().write(json);
                        })
                )
